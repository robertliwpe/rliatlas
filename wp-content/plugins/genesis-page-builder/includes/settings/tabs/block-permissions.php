...
function register_block_permissions_section_and_fields() {
	...
	add_settings_field(
		...
		[
			...
			'content' => __( '<p>Choose which Genesis Pro block settings can be controlled by different user roles. <a target="_blank" rel="noopener noreferrer" href="https://developer.wpengine.com/genesis-pro/genesis-page-builder/block-permissions/">View Documentation →</a></p>', 'genesis-page-builder' ),
			'type'    => 'html',
		]
	);
}
